// Home page. Welcome message and feature highlights.

function Home() {
    return (
        <div className="container mx-auto px-4 py-8 mt-20 sm:mt-16 pt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-10 py-50">
