        ...
        <div className="container mx-auto px-4 py-8 mt-20 sm:mt-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-xl shadow-xl flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                    <img src="/src/assets/html.svg" alt="HTML5 Logo" className="w-14 h-14 mb-3" />
                ...
                {/* CSS */}
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-xl shadow-xl flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                    <img src="/src/assets/css.svg" alt="CSS Logo" className="w-14 h-14 mb-3" />
                ...
                {/* JavaScript */}
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-xl shadow-xl flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                    <img src="/src/assets/javascript.svg" alt="JavaScript Logo" className="w-14 h-14 mb-3" />
                ...
                {/* PHP */}
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-xl shadow-xl flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                    <img src="/src/assets/php.svg" alt="PHP Logo" className="w-14 h-14 mb-3" />
                ...
                {/* Bootstrap */}
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-xl shadow-xl flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                    <img src="/src/assets/bootstrap.svg" alt="Bootstrap Logo" className="w-14 h-14 mb-3" />
                ...
                {/* Tailwind CSS */}
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-xl shadow-xl flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                    <img src="/src/assets/tailwindcss.svg" alt="Tailwind CSS Logo" className="w-14 h-14 mb-3" />
